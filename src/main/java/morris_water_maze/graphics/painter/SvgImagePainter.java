...
public final class SvgImagePainter implements ImagePainter
{
    private final int
        imageSize;
    ...
    {
        ImagePainter imagePainter = new SvgImagePainter(imageSize);
        imagePainter.setBackground(background);
        imagePainter.initializeImage();
        return imagePainter;
    }
    
    private SvgImagePainter(int imageSize)
    {
