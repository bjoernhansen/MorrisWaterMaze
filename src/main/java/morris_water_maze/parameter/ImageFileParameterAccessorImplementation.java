...
public class ImageFileParameterAccessorImplementation implements ImageFileParameterAccessor
{
    private final int
        numberOfPics;
    ...
    public ImageFileParameterAccessorImplementation(Properties parameter)
    {
