...
{
    public static SimulationController newInstance(Simulation simulation, ParameterProviderGenerator parameterProviderGenerator)
    {
        boolean isStartingWithGui = parameterProviderGenerator.getSimulationParameterProvider()
                                                              .isStartingWithGui();
        if(isStartingWithGui)
        {
            return GUI_TYPE == GuiType.SWING
                ? new SwingSimulationController(simulation, parameterProviderGenerator)
